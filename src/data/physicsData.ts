  ...
  // 1. PROJECTILE MOTION
  {
    ...
    specialCases: [
      ...
      },
      {
        ...
        conditionLatex: '\\alpha = 20^\\circ, \\; y_{\\text{terrain}} = x \\tan\\alpha',
        description: 'Trajectory fired up a 20° incline with realistic oblique plane impact and rolling restitution.',
        formulaLatex: 'R_{\\text{incline}} = \\frac{2u^2\\sin(\\theta - \\alpha)\\cos\\theta}{g\\cos^2\\alpha}',
